...
import rpt.tool.letshydrate.utils.AppUtils.Companion.notificationId
import rpt.tool.letshydrate.utils.log.i
import java.util.concurrent.TimeUnit
import rpt.tool.letshydrate.utils.notifications.NotifierReceiver
import rpt.tool.letshydrate.utils.notifications.BootReceiver

class AlarmHelper {
    private var alarmManager: AlarmManager? = null

    private val ACTION_BD_NOTIFICATION = "rpt.tool.letshydrate.NOTIFICATION"
