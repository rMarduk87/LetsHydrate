package rpt.tool.mementobibere.ui.statistics.all
...
class AllStatsFragment: BaseFragment<AllStatsFragmentBinding>(AllStatsFragmentBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnBack.setOnClickListener {
            safeNavController?.safeNavigate(AllStatsFragmentDirections
                .actionAllstatsFragmentToDrinkFragment())
        }
    }
    ...
    private fun goToIntookStats() {
        safeNavController?.safeNavigate(AllStatsFragmentDirections.
        actionAllstatsFragmentToToIntookFragment())
    }

    private fun goToReachedGoalStats() {
        safeNavController?.safeNavigate(AllStatsFragmentDirections
            .actionAllstatsFragmentToGoalFragment())
    }
