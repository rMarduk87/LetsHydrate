package rpt.tool.mementobibere.ui.libraries.alert.dialog;
...
public class OptAnimationLoader {
    ...
    public static Animation loadAnimation(@NonNull Context context, int id)
    ...
    private static Animation createAnimationFromXml(Context c, @NonNull XmlPullParser parser,
