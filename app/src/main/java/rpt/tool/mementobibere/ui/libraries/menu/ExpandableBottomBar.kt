...
import rpt.tool.mementobibere.ui.libraries.menu.ExpandableBottomBar.ItemStyle.Companion.toItemStyle
import rpt.tool.mementobibere.ui.libraries.menu.behavior.ExpandableBottomBarBehavior
import rpt.tool.mementobibere.ui.libraries.menu.parsers.ExpandableBottomBarParser
import rpt.tool.mementobibere.ui.libraries.menu.state.BottomBarSavedState
import rpt.tool.mementobibere.ui.libraries.menu.utils.*
...
class ExpandableBottomBar @JvmOverloads constructor(
    ...
    internal enum class ItemStyle(private val id: Int) {
        ...
        companion object {
            ...
            fun Int.toItemStyle(): rpt.tool.mementobibere.ui.libraries.menu.ExpandableBottomBar.ItemStyle = values().find { it.id == this }
    ...
    private val menuImpl: rpt.tool.mementobibere.ui.libraries.menu.MenuImpl
    private val styleController: StyleController
    private val stateController =
        rpt.tool.mementobibere.ui.libraries.menu.ExpandableBottomBar.ExpandableBottomBarStateController(
            this
        )
    ...
    val menu: rpt.tool.mementobibere.ui.libraries.menu.Menu
    get() {
        return menuImpl
    }

    var onItemSelectedListener: rpt.tool.mementobibere.ui.libraries.menu.OnItemClickListener?
    get() {
    ...
    var onItemReselectedListener: rpt.tool.mementobibere.ui.libraries.menu.OnItemClickListener?
    get() {
    ...
    init {
        ...
        val menuItemFactory =
            rpt.tool.mementobibere.ui.libraries.menu.MenuItemFactory(
                this,
                styleController,
                menuVerticalPadding,
        ...
        menuImpl = rpt.tool.mementobibere.ui.libraries.menu.MenuImpl(
            this,
            menuItemFactory,
    ...
    override fun getBehavior(): CoordinatorLayout.Behavior<*> =
        ExpandableBottomBarBehavior<rpt.tool.mementobibere.ui.libraries.menu.ExpandableBottomBar>()
    ...
    internal class ExpandableBottomBarStateController(
        private val expandableBottomBar: rpt.tool.mementobibere.ui.libraries.menu.ExpandableBottomBar
    ) {
        ...
        private inline fun Menu.doSilently(scope: (menu: rpt.tool.mementobibere.ui.libraries.menu.Menu) -> Unit) {
